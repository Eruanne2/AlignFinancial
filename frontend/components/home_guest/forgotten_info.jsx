      ...
      <div className='forgot-username'>
        ...
        <h2>Please enter the email address associated with your account: 
          <div className='icon-holder' onMouseOver={this.toggleTooltip} onMouseOut={this.toggleTooltip}>
            ...
            {this.state.infoTooltip && <div id='email-tooltip' data-email-tooltip="Feel free to enter a real email address here. This information will not be saved, and you will receive an email even if the email is not associated with a bank account."></div>}
          </div>
        </h2>
